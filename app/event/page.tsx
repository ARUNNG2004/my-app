      ...
      <section className="px-6 md:px-16 pb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredEvents.map((event) => (
            <div key={event.id} className="bg-white rounded-[32px] overflow-hidden shadow-sm hover:shadow-xl transition-all group flex flex-col h-full border border-gray-100/50">
              {/* Card Header (Edge-to-edge as per image_218664.png) */}
              <div className={`h-56 bg-gradient-to-b ${event.gradient} relative p-6`}>
              ...
              <div className="px-6 py-5 flex-grow">
                ...
                <div className="flex flex-wrap items-center gap-x-2 gap-y-3">
                  <div className="flex items-center gap-2 text-[#718096]">
                    <Calendar size={20} strokeWidth={2.5} className="text-[#A0AEC0]" />
                    <span className="font-bold text-sm tracking-tight">{event.date}</span>
                  </div>
                  <div className="flex items-center gap-2 text-[#718096]">
                    <MapPin size={20} strokeWidth={2.5} className="text-[#A0AEC0]" />
                    <span className="font-bold text-sm tracking-tight">{event.location}</span>
                  </div>
                  <div className="flex items-center gap-2 text-[#718096]">
                    <Users size={20} strokeWidth={2.5} className="text-[#A0AEC0]" />
                    <span className="font-bold text-sm tracking-tight">{event.seats}</span>
                  </div>
                </div>
              </div>
