    ...
    <footer className="bg-[#0f172a] text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="flex justify-center mb-16">
          <div className="bg-white/5 border border-white/10 px-6 py-2 rounded-full flex items-center gap-2 text-sm font-medium backdrop-blur-md">
            <span>Made with</span>
            <Heart className="w-4 h-4 text-red-500 fill-red-500 animate-pulse" />
            <span>
              by <span className="text-blue-400">Akshansh</span> for Bug to Build
            </span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 text-center sm:text-left">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3 text-slate-400 font-medium">
              ...
              <li><a href="#" className="hover:text-white transition">Event Page</a></li>
              <li><a href="#" className="hover:text-white transition">Steps Page</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex justify-center sm:justify-start gap-4">
              <a href="#" className="w-12 h-12 bg-gradient-to-br from-purple-600 to-pink-500 rounded-2xl flex items-center justify-center hover:scale-110 transition shadow-lg shadow-pink-500/20">
                <FaInstagramSquare className="w-6 h-6" />
              </a>
              <a href="#" className="w-12 h-12 bg-[#0077b5] rounded-2xl flex items-center justify-center hover:scale-110 transition shadow-lg shadow-blue-500/20">
